---
name: fire3d-fe-handoff
description: Resume or checkpoint a Fire3D FE task using repo-local handoff and lessons. Use for continuing, pausing, or handing off work in FE, not for other repos or automatic releases.
---

# Bàn giao FE

1. Xác định gốc repo chứa skill này (đi lên từ .agents/skills/fire3d-fe-handoff); đọc AGENTS.md và .codex/context.md, .codex/workflow.md tại gốc đó. Không dựa vào cwd đang ở workspace cha hoặc repo khác.
